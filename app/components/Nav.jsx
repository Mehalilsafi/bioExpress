...
export default function Nav() {
  return (
    <header className="flex mx-3.5 w-full items-center justify-between ">
      <Image src={logo} width={100} height={100} alt="Picture of the author" />

      <div className="relative">
  <FontAwesomeIcon
    icon={faMagnifyingGlass}
    className="absolute inset-y-0 left-0 pl-3 self-center mt-3 md:mt-0 text-gray-400 pointer-events-none"
  />
  <input
    type="text"
