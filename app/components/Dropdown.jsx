...
const Dropdown = () => {
  ...
  return (
    <div className="m-1 relative inline-flex">
      ...
      {isOpen && (
        <div
          className="transition-[opacity,margin] duration opacity-100 min-w-60 bg-white shadow-md rounded-lg p-2 mt-2 dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:divide-neutral-700 relative"
          aria-labelledby="hs-dropdown-hover-event"
        >
          <div className="after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full"></div>
          <Link
