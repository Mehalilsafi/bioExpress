...
const DeliverySignup = () => {
    return (
        ...
        <form className="flex flex-col w-full ">
            ...
            <label htmlFor="input-label" className="block text-sm font-medium mb-2 dark:text-white mt-6 text-[#918A8A]">Your situation</label>
            ...
            <label htmlFor="input-label" className="block text-sm font-medium mb-2 mt-5 dark:text-white text-[#918A8A]">Adress</label>
            <input
            type="text"
            className="py-2 px-2 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
            />
            ...
            <label htmlFor="input-label" className="block text-sm font-medium mb-2 mt-5 dark:text-white text-[#918A8A]">Phone Number</label>
            <input
            type="text"
            className="py-2 px-2 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
            />
            ...
            <label htmlFor="input-label" className="block text-sm font-medium mb-2 mt-5 dark:text-white text-[#918A8A]">Do you own any vehicle ?</label>
            <input
            type="text"
            className="py-2 px-2 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
            />
